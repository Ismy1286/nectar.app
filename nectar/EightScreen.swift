...
class EightScreen: UIViewController {
    ...
    private lazy var labelText21: UILabel = {
        let view = UILabel()
        view.textColor = UIColor(red: 124/255, green: 124/255, blue: 124/255, alpha: 1)
        view.font = .systemFont(ofSize: 16, weight: .semibold)
        view.text = "Email"
    ...
    private lazy var labelText22: UITextField = {
        let view = UITextField()
        view.textColor = UIColor(red: 24/255, green: 23/255, blue: 37/255, alpha: 1)
        view.font = .systemFont(ofSize: 18)
        view.clearsOnBeginEditing = true
    ...
    private lazy var pixImage12: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(red: 226/255, green: 226/255, blue: 226/255, alpha: 1)
        return view
    }()
    ...
    private func setupSubview(){
        ...
        view.addSubview(labelText21)
        labelText21.snp.makeConstraints { make in
            make.top.equalTo(pixImage.snp.bottom).offset(view.frame.height * 0.035)
            make.left.equalToSuperview().offset(view.frame.width * 0.075)
        }
        view.addSubview(labelText22)
        labelText22.snp.makeConstraints { make in
            make.top.equalTo(labelText21.snp.bottom).offset(view.frame.height * 0.02)
            make.left.equalToSuperview().offset(view.frame.width * 0.075)
            make.width.equalToSuperview().multipliedBy(0.75)
        }
        view.addSubview(tickImage)
        tickImage.snp.makeConstraints { make in
            make.centerY.equalTo(labelText22)
            make.right.equalToSuperview().offset(view.frame.width * (-0.075))
        }
        view.addSubview(pixImage12)
        pixImage12.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(tickImage.snp.bottom).offset(view.frame.height * 0.017)
            make.height.equalTo(1)
            make.width.equalToSuperview().multipliedBy(0.85)
        }
        view.addSubview(labelText33)
        labelText33.snp.makeConstraints { make in
            make.top.equalTo(pixImage12.snp.bottom).offset(view.frame.height * 0.035)
            make.left.equalToSuperview().offset(view.frame.width * 0.075)
        }
